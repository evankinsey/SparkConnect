# SparkConnect — 14-Day Content Queue

One feature per video. Every claim here is provable from the app (tools, Sparky
limits, pricing). **Nothing posts automatically** — these are drafts; a human shoots,
reviews, and posts. Day 1 has its full asset set in `launch-package.md`.
...
### Day 1 — LAUNCH 🚀  (Theme: App Store launch · Feature: montage)
→ **Full package in `launch-package.md`.** Hook: "I'm an electrician and I built the app I wish I had on day one."
...
### Day 4 — Daily code question  (Theme: Code question · Feature: Code Quiz)
- **Hook:** "Daily code question — comment A, B, C, or D."
- **Script beats:** (1) Read the question to camera. (2) [SCREEN] show the Code Quiz question. (3) "Comment before I show the answer." (4) Reveal next day or in comments.
...
### Day 5 — Founder story  (Theme: Built by an electrician · Feature: app B-roll)
- **Hook:** "I'm an electrician. I built the app I wish I had as an apprentice."
- **Script beats:** (1) Talking head: who you are, the trade. (2) The frustration (scattered calcs, code book in the truck). (3) [B-ROLL] quick app montage. (4) "Built by the trade, for the trade."
- **Shot list:** talking head → 3 fast screen cuts (Conduit Fill, Sparky, Pipe Bending).
- **On-screen text:** "Built by an electrician"
- **Caption:** What would've saved you the most time in your first year? 👇
- **CTA:** Follow for the build in public. (no hard sell)
- **Hashtags:** #electrician #buildinpublic #ibew #tradeschool #apprentice #electricianlife #electrical #foundersjourney
- **Thumbnail:** "BUILT BY A SPARKY"

### Day 6 — Box fill demo  (Theme: Conduit/Box fill · Feature: Box Fill)
- **Hook:** "Box fill in four taps."
- **Script beats:** (1) Hook. (2) [SCREEN] open Box Fill, add conductors/devices/clamps. (3) Show result update live. (4) "No more counting on your fingers."
...
### Day 7 — Pain point  (Theme: Pain points · Feature: Conduit Fill)
- **Hook:** "POV: the inspector asks about your conduit fill and you froze."
- **Script beats:** (1) Acted "froze" beat. (2) "Happens to everyone." (3) [SCREEN] pull it up in Conduit Fill, calm. (4) "Never get caught again."
...
### Day 8 — Pipe bending  (Theme: Pipe bending · Feature: Pipe Bending)
- **Hook:** "Offset bend math, without the headache."
- **Script beats:** (1) Hook. (2) [SCREEN] Pipe Bending: enter offset + angle. (3) Show shrink/marks. (4) "Bend it right the first time."
- **Shot list:** Pipe Bending → enter values → show results → optional real EMT bend B-roll.
...
### Day 9 — Jobsite mistake: voltage drop  (Theme: Mistakes/tips · Feature: Voltage Drop)
- **Hook:** "That long run nobody calculated for."
- **Script beats:** (1) Hook. (2) "Voltage drop will get you a callback." (3) [SCREEN] Voltage Drop calc on a long run. (4) "Upsize before you pull."
...
### Day 10 — Sparky free tier  (Theme: Sparky/launch · Feature: Sparky)
- **Hook:** "Free electrician AI — 3 answers a day, no subscription."
- **Script beats:** (1) Hook. (2) [SCREEN] ask Sparky 2 quick real questions. (3) "Free every day. Want more? Packs from $1.99, or Pro." (4) honest pricing.
...
### Day 11 — Ampacity derating  (Theme: Mistakes/tips · Feature: Ampacity)
- **Hook:** "The derating everyone forgets."
- **Script beats:** (1) Hook. (2) "6 current-carrying conductors in a raceway — now what?" (3) [SCREEN] Ampacity + derating. (4) "Don't size from memory."
...
### Day 12 — Exam prep  (Theme: Code question · Feature: Exam Prep)
- **Hook:** "Journeyman exam prep on your lunch break."
- **Script beats:** (1) Hook. (2) [SCREEN] Exam Prep / Code Quiz run a few. (3) "Five questions, every break." (4) "Pass the first time."
...
### Day 13 — Founder: apprentice advice  (Theme: Built by an electrician · Feature: app B-roll)
- **Hook:** "What I'd tell a first-year apprentice."
- **Script beats:** (1) Talking head: 2-3 real pieces of advice. (2) "Tools matter, but so do reps." (3) [B-ROLL] soft app mention. (4) "Save this for your apprentice."
- **Shot list:** talking head → one app cut → end card.
- **On-screen text:** "First-year advice"
- **Caption:** Apprentices — what do you wish someone told you sooner? 👇
- **CTA:** Follow for more from the field.
- **Hashtags:** #apprentice #electrician #tradeschool #ibew #electricianlife #mentorship #electrical #advice
- **Thumbnail:** "FIRST-YEAR ADVICE"

### Day 14 — Recap montage + launch special  (Theme: Launch · Feature: montage)
- **Hook:** "Everything an electrician needs — in one app."
- **Script beats:** (1) Fast montage of tools (Conduit Fill, Box Fill, Voltage Drop, Pipe Bending, Sparky, Code Quiz, Job Cam). (2) "Free to download." (3) "Pro is $7.99/mo or $49.99/yr — launch special." (4) hard CTA.
...
1. Import `content-queue-seed.csv` into the **Content Queue** tab (File > Import > Replace current sheet, or paste).
2. For any day, run the **Master Prompt** (or the n8n Content Draft Factory) to expand beats → full script + B-roll prompt + variations. The launch (Day 1) is already fully expanded.
3. Shoot → set Status to `Draft Ready` → review → `Approved` → `Scheduled` → post → log in **Posted Content**.
