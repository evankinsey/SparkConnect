...
import { REVIEW_CHECKLIST, ReviewStatus, isProductionVisible } from '../src/circuit/review.js';
...
const writeApprovals = (data) => {
  ...
  writeFileSync(APPROVALS_MODULE_PATH,
    ...
    '//\n' +
    '// An approval is tied to `lessonVersion`. Editing a lesson bumps its version,\n' +
